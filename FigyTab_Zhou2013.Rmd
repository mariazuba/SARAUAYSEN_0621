...
# PCOM  Posterior-focused catch-only method  S. Zhou, Modificado por Elson Leal  para sardina austral Aysen 2019, CBA 2020 
...
```{r Fig2_Zhou2013_depletion, eval=T,warning=F, include=T, message=F, echo=T,fig.height=8,fig.width=8,fig.align="center",fig.path="Figuras/",dev="pdf"}
#######################################################
...
```{r Fig3_Zhou2013_sensitivity, eval=T,warning=F, include=T, message=F, echo=T,fig.height=8,fig.width=8,fig.align="center",fig.path="Figuras/",dev="pdf"}
...
```{r Fig4_Zhou2013_fase, eval=T,warning=F, include=T, message=F, echo=T,fig.height=8,fig.width=8,fig.align="center",fig.path="Figuras/",dev="pdf" }
##################################################################################################
...
```{r Fig5_Zhou2013_Proyeccion_B,eval=T,warning=F, include=T, message=F, echo=T,fig.height=8,fig.width=8,fig.align="center",fig.path="Figuras/",dev="pdf"}
...
legend(2021,rng1[2]*0.5,c(expression(F[paste("0.35")]),expression(F[paste("0.46")]),
...
```{r Fig6_Zhou2013_capturas,eval=T,warning=F, include=T, message=F, echo=T,fig.height=8,fig.width=8,fig.align="center",fig.path="Figuras/",dev="pdf"}
